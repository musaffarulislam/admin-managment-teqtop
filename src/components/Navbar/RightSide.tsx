...
export const RightSide = () => {
    ...
    return (
        <div className='flex items-center'>
            ...
            <div className='flex'>
                <div className='relative cursor-pointer'  onClick={()=>handleButtons()}>
                ...
                <div className='w-6 h-6 flex justify-center items-center bg-gray rounded-full ms-2 cursor-pointer'  onClick={()=>handleButtons()}>
                    <img
